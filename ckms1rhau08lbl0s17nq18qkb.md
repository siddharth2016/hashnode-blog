...
This is possible because of something called tuple unpacking (not an advanced topic, you will learn that in tuples, if not already, try this [link](https://realpython.com/lessons/tuple-assignment-packing-unpacking/) for more info).
